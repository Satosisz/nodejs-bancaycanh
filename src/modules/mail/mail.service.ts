		...
		try {
			...
			const result = await this.transporter.sendMail({
                ...
                <div style='margin-left: 20px; font-size: 14px; overflow: auto; height: 400px; display: block;'>
                    ...
                    <br>
                    <div style=' color:#000;'>Tên khách hàng: ${data.tst_name
					}</div>
                    <div style=' color:#000;'>Email: <a style='color: #007bff !important;text-decoration: none;'>${data.tst_email
					}</a></div>
                    <div style=' color:#000;'>Phone: ${data.tst_phone}</div>
                    <br>
